...
export const instructionsSteps = [
  {
      ...
      description: 'Aquí podrás darle seguimiento a los proyectos que estás investigando o en los que ya has invertido. \n\n ¡Vamos a descubrirlo!',
      img: '/encontrar.svg',
  },
  {
      id: 2,
  ...
  {
      id: 5,
      title: 'Acá encontrarás la capitalización de mercado que tiene el proyecto que seleccionaste.',
      description: '(Al igual que en tu dashboard)',
      img: '/encontrar.svg',
  },
  {
  ...
  },
  {
      id: 7,
      title: ' \n ',
      description: 'En relación a tu precio de entrada y el precio actual del token se calcula el rendimiento que ha tenido en tu portafolio',
      img: '/encontrar.svg',
  },
  {
      id: 8,
      title: '¡Metodología 4E!.',
      description: 'En Kairos Research creamos un método de estudio llamado \“4E\” para analizar proyectos, con el objetivo guiarte hacia oportunidades de inversión informadas y sostenibles en el cambiante universo de las criptomonedas.',
  },
  {
      id: 8,
      title: '¡Metodología 4E!',
  ...
  },
  {
      ...
      description: 'Puedes agregarlo a tu “Lista de seguimiento” para analizarlo después o puedes seleccionar “Invertir” si ya has invertido o invertirás en el proyecto.',
  },
  {
      id: 10,
      title: '¿En qué exchange lo puedes comprar?',
      description: 'Agrega el exchange centralizado o descentralizado donde puedes adquirir o ya adquiriste el token.',
  },
  {
      id: 11,
      title: '¿A qué sector pertenece el proyecto?',
      description: 'Agrega el o los sectores en los que este proyecto se encuentra.',
  },
  {
      id: 12,
  ...
  },
  {
      ...
      description: 'Da click en el proyecto y descubirás más información sobre el.',
  },
