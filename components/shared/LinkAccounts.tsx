...
const LinkAccounts = () => {
    ...
    const {linkEmail, linkWallet, linkDiscord, linkGithub, linkGoogle} = useLinkAccount({
  ...
  return (
    <div>
        <div className="grid gap-2 ">
                    ...
                    <div className="space-y-2 ">
                        <div className='cursor-pointer pl-4 p-0 hover:bg-primary/30 rounded-md' onClick={linkGoogle}>Cuenta de Google</div>
                   </div>
                    <div className="space-y-2 ">
                        <div className='cursor-pointer pl-4 p-0 hover:bg-primary/30 rounded-md' onClick={linkEmail}>Cuenta de Email {" (no google)"}</div>
                   </div>
                    <div className="space-y-2 ">
