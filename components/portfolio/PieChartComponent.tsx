    ...
    <div>
      {
        ...
        chartData.length === 0 && (
          <div>
            No logramos acceder a ningun balance en tu portafolio. Esto puede
            ser porque:
            <ol>
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              ...
                              {network === "optimism" &&
                                portafolio.optimism.TotalBalance.toLocaleString()}
                              {network === "base" &&
                                portafolio.base.TotalBalance.toLocaleString()}
                            </tspan>
                            <tspan
                              x={viewBox.cx}
                              y={(viewBox.cy || 0) + 24}
