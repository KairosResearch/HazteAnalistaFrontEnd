  ...
  return (
    ...
    <Tabs>
        ...
        <TabsList className="gap-5" defaultValue="arb">
            ...
            <TabsTrigger onClick={() => setNetwork('ethereum')}className={`border border-black/80 dark:border-foreground  rounded-sm text-2xl font-bold 
            ...
            <TabsTrigger onClick={() => setNetwork('scroll')}className={`border border-black/80 dark:border-foreground rounded-sm text-2xl font-bold 
             `} value="advja">Scroll</TabsTrigger>
             <TabsTrigger onClick={() => setNetwork('optimism')}className={`border border-black/80 dark:border-foreground rounded-sm text-2xl font-bold 
             `} value="asdja">Optimism</TabsTrigger>
             <TabsTrigger onClick={() => setNetwork('polygon')}className={`border border-black/80 dark:border-foreground rounded-sm text-2xl font-bold 
             `} value="adjaa">Polygon</TabsTrigger>
             <TabsTrigger onClick={() => setNetwork('base')}className={`border border-black/80 dark:border-foreground rounded-sm text-2xl font-bold 
             `} value="adeja">Base</TabsTrigger>
        </TabsList>
    </Tabs>
