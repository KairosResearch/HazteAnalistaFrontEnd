...
const ProgressBars = () => {
  ...
  React.useEffect(() => {
    if (token1 && token2 && token1.trim() !== "" && token2.trim() !== "") {
      ...
      console.log(
        "Llegando al useEffect que se actualiza cada vez que se cambia un token",
      );
      ...
      {!sameToken && !loading && comparativeInfo.length != 0 && (
        <>
          ...
          <div className="flex items-center w-3/5 mx-auto justify-between font-bold text-2xl">
            ...
            <p>{comparativeInfo[0].NoX.toFixed(2)}X</p>
          </div>
          <div className="w-4/5 mx-auto flex flex-col gap-1">
            <div className="flex justify-between items-center">
              ...
              <div>
                {/* <Image
                            ...
                            /> */}
                <span>
                  {higherMarketCap === comparativeInfo[0].MakCapA
                    ? token1
                    : token2}
                </span>
              </div>
            ...
            <div className="flex justify-center gap-4 items-center">
              ...
              <p className="text-green-light bg-primary dark:bg-transparent p-2 rounded-sm">
                {(
                  (comparativeInfo[0].MakCapA / comparativeInfo[0].MakCapB) *
                  100
                )
                  .toFixed(2)
                  .toLocaleString()}
